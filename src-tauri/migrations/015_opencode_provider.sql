-- Add 'OpenCode' to the provider CHECK constraint on the threads table.
-- SQLite requires table recreation to modify CHECK constraints.
--
-- Mirrors migration 014 (Droid) — enumerates all columns explicitly in both
-- the CREATE and the INSERT to avoid silent data loss if the schema drifts
-- further.
...
CREATE TABLE threads_new (
    ...
    name TEXT NOT NULL,
    provider TEXT NOT NULL CHECK (provider IN ('ClaudeCode', 'Codex', 'Ollama', 'Droid', 'OpenCode')),
