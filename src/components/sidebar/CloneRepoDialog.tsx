      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-[420px] rounded-[20px] border border-white/[0.08] shadow-2xl fx-dialog"
            style={{
            ...
            <form onSubmit={handleClone} className="p-5 space-y-4">
              ...
              <div>
                ...
                <div className="ui-seg flex gap-1 rounded-lg border border-white/[0.06] p-1" style={{ background: "rgba(255,255,255,0.03)" }}>
                  <button
                    ...
                    data-active={method === "https" ? "true" : undefined}
                    className={`ui-seg-item flex-1 rounded-md px-3 py-1.5 text-xs font-medium transition-all duration-200 ${
                      method === "https"
                  ...
                  <button
                    ...
                    data-active={method === "ssh" ? "true" : undefined}
                    className={`ui-seg-item flex-1 rounded-md px-3 py-1.5 text-xs font-medium transition-all duration-200 ${
                      method === "ssh"
                        ? "bg-white/[0.1] text-zinc-200"
                        : "text-zinc-500 hover:text-zinc-400"
                      ...
                      <AnimatePresence>
                        {showSshDropdown && (
                          <motion.div
                            ...
                            className="absolute left-0 right-0 top-full z-10 mt-1 rounded-lg border border-white/[0.08] py-1 shadow-xl fx-dialog"
              ...
              <div>
                ...
                <button
                  ...
                  disabled={!dialogOpen}
                  className="flex w-full items-center gap-2.5 rounded-lg border border-white/[0.06] px-3 py-2.5 text-left text-sm text-zinc-300 hover:bg-white/[0.06] hover:border-white/[0.1] transition-all duration-200 disabled:opacity-40 fx-input"
                  style={{ background: "rgba(255,255,255,0.03)" }}
                >
              ...
              {/* Error */}
              {error && (
                <div className="rounded-lg border border-red-500/20 bg-red-500/10 px-3 py-2 text-xs text-red-400 fx-soft-red">
                  {error}
                </div>
              )}
