...
### Improved
- A cleaner look that matches agmux.dev and the phone app: new type, flat panels, clearer status colors, and a new app icon. Prefer the old frosted look? Choose Settings → Appearance → Surfaces → Glass. The previous font, Geist, is still in Settings → Typography.
