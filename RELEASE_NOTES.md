...
- **Teams history is kept when uploads pause** — When a team's trial ends and its dashboards become read-only, its members' past activity now stays visible instead of disappearing on their next sync.
