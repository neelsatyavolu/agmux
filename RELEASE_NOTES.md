...
- **Committed changes in a new task** — Before a task's branch is pushed, the committed-changes list in Commit and the Git panel shows only the task's own work, not other people's changes from the main branch.
